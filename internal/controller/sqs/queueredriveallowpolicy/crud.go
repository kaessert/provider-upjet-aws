...
func (e *ExternalClient) Observe(_ context.Context, _ QueueRedriveAllowPolicyCR) (managed.ExternalObservation, error) {
	return managed.ExternalObservation{}, errors.New("not implemented")
}

// Create creates the external QueueRedriveAllowPolicy resource.
func (e *ExternalClient) Create(_ context.Context, _ QueueRedriveAllowPolicyCR) (managed.ExternalCreation, error) {
	return managed.ExternalCreation{}, errors.New("not implemented")
}

// Update updates the external QueueRedriveAllowPolicy resource.
func (e *ExternalClient) Update(_ context.Context, _ QueueRedriveAllowPolicyCR) (managed.ExternalUpdate, error) {
	return managed.ExternalUpdate{}, errors.New("not implemented")
}

// Delete deletes the external QueueRedriveAllowPolicy resource.
func (e *ExternalClient) Delete(_ context.Context, _ QueueRedriveAllowPolicyCR) (managed.ExternalDelete, error) {
