...
// Package subnetgroupraw contains the namespaced-scope native controller for
...
// Setup adds a controller that reconciles SubnetGroupRAW managed resources (namespaced).
