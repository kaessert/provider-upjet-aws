...
// Package secretpolicyraw contains the namespaced-scope native controller for
...
// Setup adds a controller that reconciles SecretPolicyRAW managed resources (namespaced).
