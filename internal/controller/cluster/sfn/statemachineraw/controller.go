...
// Package statemachineraw contains the cluster-scoped native controller for
...
import (
	...
	nativev1beta2 "github.com/upbound/provider-aws/v2/apis/cluster/sfn/v1beta2/native"
...
func init() {
	...
	clustercontroller.NativeSetupHook_sfn = Setup
}

// Setup adds a controller that reconciles StateMachineRAW managed resources.
