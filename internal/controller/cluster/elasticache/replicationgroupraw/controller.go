...
// Package replicationgroupraw contains the cluster-scoped native controller for
...
// Setup adds a controller that reconciles ReplicationGroupRAW managed resources.
