...
// Package serverlesscacheraw contains the cluster-scoped native controller for
...
// Setup adds a controller that reconciles ServerlessCacheRAW managed resources.
