...
// Package globalreplicationgroupraw contains the cluster-scoped native controller for
...
// Setup adds a controller that reconciles GlobalReplicationGroupRAW managed resources.
