...
// Package queueredrivepolicyraw contains the cluster-scoped native controller for
...
// Setup adds a controller that reconciles QueueRedrivePolicyRAW managed resources.
