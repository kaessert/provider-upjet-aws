...
// Package sqs registers all native cluster-scoped SQS controllers by setting
...
import (
	...
	"github.com/upbound/provider-aws/v2/internal/controller/cluster/sqs/queuepolicyraw"
	"github.com/upbound/provider-aws/v2/internal/controller/cluster/sqs/queueraw"
	"github.com/upbound/provider-aws/v2/internal/controller/cluster/sqs/queueredriveallowpolicyraw"
	"github.com/upbound/provider-aws/v2/internal/controller/cluster/sqs/queueredrivepolicyraw"
)
...
func init() {
	...
	clustercontroller.NativeSetupHook_sqs = SetupAll
}

// SetupAll registers all native cluster-scoped SQS controllers.
