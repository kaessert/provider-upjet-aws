...
- **[../docs/dual-generate-guide.md](../docs/dual-generate-guide.md)** — Two generate paths (`make generate` vs `make generate.native`), when to use which, coexistence invariants, common pitfalls, troubleshooting
