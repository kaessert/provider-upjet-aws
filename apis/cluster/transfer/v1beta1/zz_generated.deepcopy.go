...
func (in *EgressConfigInitParameters) DeepCopyInto(out *EgressConfigInitParameters) {
	*out = *in
	if in.VPCLattice != nil {
		in, out := &in.VPCLattice, &out.VPCLattice
		*out = make([]VPCLatticeInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *EgressConfigObservation) DeepCopyInto(out *EgressConfigObservation) {
	*out = *in
	if in.VPCLattice != nil {
		in, out := &in.VPCLattice, &out.VPCLattice
		*out = make([]VPCLatticeObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *EgressConfigParameters) DeepCopyInto(out *EgressConfigParameters) {
	*out = *in
	if in.VPCLattice != nil {
		in, out := &in.VPCLattice, &out.VPCLattice
		*out = make([]VPCLatticeParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VPCLatticeInitParameters) DeepCopyInto(out *VPCLatticeInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VPCLatticeInitParameters.
func (in *VPCLatticeInitParameters) DeepCopy() *VPCLatticeInitParameters {
	if in == nil {
		return nil
	}
	out := new(VPCLatticeInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VPCLatticeObservation) DeepCopyInto(out *VPCLatticeObservation) {
	*out = *in
	if in.PortNumber != nil {
		in, out := &in.PortNumber, &out.PortNumber
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VPCLatticeObservation.
func (in *VPCLatticeObservation) DeepCopy() *VPCLatticeObservation {
	if in == nil {
		return nil
	}
	out := new(VPCLatticeObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VPCLatticeParameters) DeepCopyInto(out *VPCLatticeParameters) {
	*out = *in
	if in.PortNumber != nil {
		in, out := &in.PortNumber, &out.PortNumber
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VPCLatticeParameters.
func (in *VPCLatticeParameters) DeepCopy() *VPCLatticeParameters {
	if in == nil {
		return nil
	}
	out := new(VPCLatticeParameters)
	in.DeepCopyInto(out)
	return out
}
