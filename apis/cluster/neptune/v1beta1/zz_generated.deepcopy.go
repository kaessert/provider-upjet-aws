...
func (in *ParameterGroupInitParameters) DeepCopyInto(out *ParameterGroupInitParameters) {
	*out = *in
	...
	if in.Parameter != nil {
		in, out := &in.Parameter, &out.Parameter
		*out = make([]ParameterGroupParameterInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ParameterGroupParameterInitParameters) DeepCopyInto(out *ParameterGroupParameterInitParameters) {
	*out = *in
...
func (in *ParameterGroupParameterInitParameters) DeepCopy() *ParameterGroupParameterInitParameters {
	if in == nil {
		return nil
	}
	out := new(ParameterGroupParameterInitParameters)
	in.DeepCopyInto(out)
	return out
}
