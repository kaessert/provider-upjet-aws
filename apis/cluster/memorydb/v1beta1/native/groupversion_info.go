...
const (
	// CRDGroup is the API Group for all native memorydb cluster-scoped types in this package.
	CRDGroup = "memorydb.aws.upbound.io"

	// CRDVersion is the API Version for all native memorydb types in this package.
	CRDVersion = "v1beta1"
)
