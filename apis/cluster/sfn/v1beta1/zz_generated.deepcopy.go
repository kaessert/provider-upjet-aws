...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StateMachineEncryptionConfigurationInitParameters) DeepCopyInto(out *StateMachineEncryptionConfigurationInitParameters) {
	*out = *in
	if in.KMSDataKeyReusePeriodSeconds != nil {
		in, out := &in.KMSDataKeyReusePeriodSeconds, &out.KMSDataKeyReusePeriodSeconds
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StateMachineEncryptionConfigurationInitParameters.
func (in *StateMachineEncryptionConfigurationInitParameters) DeepCopy() *StateMachineEncryptionConfigurationInitParameters {
	if in == nil {
		return nil
	}
	out := new(StateMachineEncryptionConfigurationInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StateMachineEncryptionConfigurationObservation) DeepCopyInto(out *StateMachineEncryptionConfigurationObservation) {
	*out = *in
	if in.KMSDataKeyReusePeriodSeconds != nil {
		in, out := &in.KMSDataKeyReusePeriodSeconds, &out.KMSDataKeyReusePeriodSeconds
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StateMachineEncryptionConfigurationObservation.
func (in *StateMachineEncryptionConfigurationObservation) DeepCopy() *StateMachineEncryptionConfigurationObservation {
	if in == nil {
		return nil
	}
	out := new(StateMachineEncryptionConfigurationObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StateMachineEncryptionConfigurationParameters) DeepCopyInto(out *StateMachineEncryptionConfigurationParameters) {
	*out = *in
	if in.KMSDataKeyReusePeriodSeconds != nil {
		in, out := &in.KMSDataKeyReusePeriodSeconds, &out.KMSDataKeyReusePeriodSeconds
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StateMachineEncryptionConfigurationParameters.
func (in *StateMachineEncryptionConfigurationParameters) DeepCopy() *StateMachineEncryptionConfigurationParameters {
	if in == nil {
		return nil
	}
	out := new(StateMachineEncryptionConfigurationParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *StateMachineInitParameters) DeepCopyInto(out *StateMachineInitParameters) {
	*out = *in
	...
	if in.EncryptionConfiguration != nil {
		in, out := &in.EncryptionConfiguration, &out.EncryptionConfiguration
		*out = make([]StateMachineEncryptionConfigurationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *StateMachineObservation) DeepCopyInto(out *StateMachineObservation) {
	*out = *in
	...
	if in.EncryptionConfiguration != nil {
		in, out := &in.EncryptionConfiguration, &out.EncryptionConfiguration
		*out = make([]StateMachineEncryptionConfigurationObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *StateMachineParameters) DeepCopyInto(out *StateMachineParameters) {
	*out = *in
	...
	if in.EncryptionConfiguration != nil {
		in, out := &in.EncryptionConfiguration, &out.EncryptionConfiguration
		*out = make([]StateMachineEncryptionConfigurationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
