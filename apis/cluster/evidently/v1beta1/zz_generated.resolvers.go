...
func (mg *Feature) ResolveReferences( // ResolveReferences of this Feature.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("evidently.aws.upbound.io", "v1beta1", "Project", "ProjectList")
		if err != nil {
