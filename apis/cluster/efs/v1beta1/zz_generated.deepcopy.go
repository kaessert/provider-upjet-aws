...
func (in *AccessPointInitParameters) DeepCopyInto(out *AccessPointInitParameters) {
	*out = *in
	...
	if in.PosixUser != nil {
		...
		*out = make([]PosixUserInitParameters, len(*in))
		for i := range *in {
	...
	if in.RootDirectory != nil {
		...
		*out = make([]RootDirectoryInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *BackupPolicyInitParameters) DeepCopyInto(out *BackupPolicyInitParameters) {
	*out = *in
	if in.BackupPolicy != nil {
		...
		*out = make([]BackupPolicyBackupPolicyInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *FileSystemInitParameters) DeepCopyInto(out *FileSystemInitParameters) {
	*out = *in
	...
	if in.Protection != nil {
		...
		*out = make([]ProtectionInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *FileSystemObservation) DeepCopyInto(out *FileSystemObservation) {
	*out = *in
	...
	if in.Protection != nil {
		in, out := &in.Protection, &out.Protection
		*out = make([]ProtectionObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *FileSystemParameters) DeepCopyInto(out *FileSystemParameters) {
	*out = *in
	...
	if in.Protection != nil {
		in, out := &in.Protection, &out.Protection
		*out = make([]ProtectionParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RootDirectoryInitParameters) DeepCopyInto(out *RootDirectoryInitParameters) {
	*out = *in
	if in.CreationInfo != nil {
		...
		*out = make([]CreationInfoInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
