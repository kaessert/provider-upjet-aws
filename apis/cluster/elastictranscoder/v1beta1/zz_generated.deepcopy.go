...
func (in *PipelineInitParameters) DeepCopyInto(out *PipelineInitParameters) {
	*out = *in
	...
	if in.ContentConfig != nil {
		...
		*out = make([]ContentConfigInitParameters, len(*in))
		for i := range *in {
	...
	if in.ThumbnailConfig != nil {
		...
		*out = make([]ThumbnailConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PresetInitParameters) DeepCopyInto(out *PresetInitParameters) {
	*out = *in
	...
	if in.AudioCodecOptions != nil {
		...
		*out = make([]AudioCodecOptionsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Thumbnails != nil {
		...
		*out = make([]ThumbnailsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
