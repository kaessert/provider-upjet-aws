...
import (
	...
	v1beta11 "github.com/upbound/provider-aws/v2/apis/cluster/ec2/v1beta1"
	...
	native1 "github.com/upbound/provider-aws/v2/internal/native"
...
func (mg *ReplicationGroupRAW) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		Extract:      native1.ExtractAtProviderField("arn"),
		Namespace:    mg.GetNamespace(),
