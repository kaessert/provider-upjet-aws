...
const (
	// CRDGroup is the API Group for all native elasticache types in this package.
	CRDGroup = "elasticache.aws.upbound.io"

	// CRDVersion is the API Version for all native elasticache types in this package.
	CRDVersion = "v1beta2"
)
