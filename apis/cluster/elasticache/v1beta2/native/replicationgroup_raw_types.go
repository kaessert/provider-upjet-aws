...
// RGLogDeliveryConfigurationRAWParameters defines the log delivery configuration for ReplicationGroup.
...
// RGLogDeliveryConfigurationRAWObservation defines observed log delivery state.
...
// NodeGroupConfigurationRAWObservation defines observed node group configuration.
...
// ReplicationGroupRAWParameters defines the configuration parameters for a native ElastiCache Replication Group (v1beta2 hub).
// Note: AtRestEncryptionEnabled and AutoMinorVersionUpgrade are *string to match TF types (NOT *bool).
// See spec §13 (Type Mismatch Fields).
type ReplicationGroupRAWParameters struct {
	...
	// If autoGenerateAuthToken is true, the Secret referenced here will be created or updated with generated auth token.
	// +kubebuilder:validation:Optional
	...
	// This is a write-only field (not returned by AWS API).
	// +kubebuilder:validation:Optional
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/elasticache/v1beta1/native.GlobalReplicationGroupRAW
	// +kubebuilder:validation:Optional
	GlobalReplicationGroupID *string `json:"globalReplicationGroupId,omitempty"`

	// Reference to a GlobalReplicationGroupRAW.
	// +kubebuilder:validation:Optional
	GlobalReplicationGroupIDRef *xpv1.NamespacedReference `json:"globalReplicationGroupIdRef,omitempty"`

	// Selector for a GlobalReplicationGroupRAW.
	// +kubebuilder:validation:Optional
...
// ReplicationGroupRAWInitParameters defines init parameters for ReplicationGroupRAW (v1beta2 hub).
...
// ReplicationGroupRAWObservation defines the observed state of ReplicationGroupRAW (v1beta2 hub).
...
// ReplicationGroupRAWSpec defines the desired state of ReplicationGroupRAW (v1beta2 hub).
...
// ReplicationGroupRAWStatus defines the observed state of ReplicationGroupRAW (v1beta2 hub).
...
// ReplicationGroupRAW is the native (non-Terraform) Schema for AWS ElastiCache Replication Group (v1beta2 hub).
//
...
// ReplicationGroupRAWList contains a list of ReplicationGroupRAW resources.
...
// Repository type metadata for ReplicationGroupRAW.
var (
