...
func (mg *Endpoint) ResolveReferences( // ResolveReferences of this Endpoint.
	...
	{
		m, l, err = apisresolver.GetManagedResource("verifiedaccess.aws.upbound.io", "v1beta1", "Group", "GroupList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *Group) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("verifiedaccess.aws.upbound.io", "v1beta1", "Instance", "InstanceList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
		rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
...
func (mg *InstanceTrustProviderAttachment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.VerifiedaccessInstanceIDRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("verifiedaccess.aws.upbound.io", "v1beta1", "TrustProvider", "TrustProviderList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
