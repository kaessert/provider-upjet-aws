...
func (in *AgentInitParameters) DeepCopyInto(out *AgentInitParameters) {
	*out = *in
	...
	if in.GuardrailConfiguration != nil {
		...
		*out = make([]GuardrailConfigurationInitParameters, len(*in))
		for i := range *in {
	...
	if in.MemoryConfiguration != nil {
		...
		*out = make([]MemoryConfigurationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AgentObservation) DeepCopyInto(out *AgentObservation) {
	*out = *in
	...
	if in.GuardrailConfiguration != nil {
		in, out := &in.GuardrailConfiguration, &out.GuardrailConfiguration
		*out = make([]GuardrailConfigurationObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.MemoryConfiguration != nil {
		in, out := &in.MemoryConfiguration, &out.MemoryConfiguration
		*out = make([]MemoryConfigurationObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AgentParameters) DeepCopyInto(out *AgentParameters) {
	*out = *in
	...
	if in.GuardrailConfiguration != nil {
		in, out := &in.GuardrailConfiguration, &out.GuardrailConfiguration
		*out = make([]GuardrailConfigurationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.MemoryConfiguration != nil {
		in, out := &in.MemoryConfiguration, &out.MemoryConfiguration
		*out = make([]MemoryConfigurationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *GuardrailConfigurationInitParameters) DeepCopy() *GuardrailConfigurationInitParameters {
	...
	out := new(GuardrailConfigurationInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GuardrailConfigurationObservation) DeepCopy() *GuardrailConfigurationObservation {
	...
	out := new(GuardrailConfigurationObservation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GuardrailConfigurationParameters) DeepCopy() *GuardrailConfigurationParameters {
	...
	out := new(GuardrailConfigurationParameters)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemoryConfigurationInitParameters) DeepCopyInto(out *MemoryConfigurationInitParameters) {
	*out = *in
	...
	if in.SessionSummaryConfiguration != nil {
		...
		*out = make([]SessionSummaryConfigurationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemoryConfigurationInitParameters.
func (in *MemoryConfigurationInitParameters) DeepCopy() *MemoryConfigurationInitParameters {
	if in == nil {
		return nil
	}
	out := new(MemoryConfigurationInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemoryConfigurationObservation) DeepCopyInto(out *MemoryConfigurationObservation) {
	*out = *in
	if in.EnabledMemoryTypes != nil {
		in, out := &in.EnabledMemoryTypes, &out.EnabledMemoryTypes
		*out = make([]*string, len(*in))
	...
	if in.SessionSummaryConfiguration != nil {
		in, out := &in.SessionSummaryConfiguration, &out.SessionSummaryConfiguration
		*out = make([]SessionSummaryConfigurationObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemoryConfigurationObservation.
func (in *MemoryConfigurationObservation) DeepCopy() *MemoryConfigurationObservation {
	if in == nil {
		return nil
	}
	out := new(MemoryConfigurationObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemoryConfigurationParameters) DeepCopyInto(out *MemoryConfigurationParameters) {
	*out = *in
	if in.EnabledMemoryTypes != nil {
		in, out := &in.EnabledMemoryTypes, &out.EnabledMemoryTypes
		*out = make([]*string, len(*in))
	...
	if in.SessionSummaryConfiguration != nil {
		in, out := &in.SessionSummaryConfiguration, &out.SessionSummaryConfiguration
		*out = make([]SessionSummaryConfigurationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemoryConfigurationParameters.
func (in *MemoryConfigurationParameters) DeepCopy() *MemoryConfigurationParameters {
	if in == nil {
		return nil
	}
	out := new(MemoryConfigurationParameters)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SessionSummaryConfigurationInitParameters) DeepCopyInto(out *SessionSummaryConfigurationInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SessionSummaryConfigurationInitParameters.
func (in *SessionSummaryConfigurationInitParameters) DeepCopy() *SessionSummaryConfigurationInitParameters {
	if in == nil {
		return nil
	}
	out := new(SessionSummaryConfigurationInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SessionSummaryConfigurationObservation) DeepCopyInto(out *SessionSummaryConfigurationObservation) {
	*out = *in
	if in.MaxRecentSessions != nil {
		in, out := &in.MaxRecentSessions, &out.MaxRecentSessions
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SessionSummaryConfigurationObservation.
func (in *SessionSummaryConfigurationObservation) DeepCopy() *SessionSummaryConfigurationObservation {
	if in == nil {
		return nil
	}
	out := new(SessionSummaryConfigurationObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SessionSummaryConfigurationParameters) DeepCopyInto(out *SessionSummaryConfigurationParameters) {
	*out = *in
	if in.MaxRecentSessions != nil {
		in, out := &in.MaxRecentSessions, &out.MaxRecentSessions
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SessionSummaryConfigurationParameters.
func (in *SessionSummaryConfigurationParameters) DeepCopy() *SessionSummaryConfigurationParameters {
	if in == nil {
		return nil
	}
	out := new(SessionSummaryConfigurationParameters)
	in.DeepCopyInto(out)
	return out
}
