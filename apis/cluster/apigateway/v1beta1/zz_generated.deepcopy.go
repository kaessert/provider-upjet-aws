...
func (in *RestAPIEndpointConfigurationInitParameters) DeepCopyInto(out *RestAPIEndpointConfigurationInitParameters) {
	*out = *in
	...
	if in.VPCEndpointIdsRefs != nil {
		in, out := &in.VPCEndpointIdsRefs, &out.VPCEndpointIdsRefs
		*out = make([]v1.Reference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.VPCEndpointIdsSelector != nil {
		in, out := &in.VPCEndpointIdsSelector, &out.VPCEndpointIdsSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *RestAPIInitParameters) DeepCopyInto(out *RestAPIInitParameters) {
	*out = *in
	...
	if in.EndpointConfiguration != nil {
		in, out := &in.EndpointConfiguration, &out.EndpointConfiguration
		*out = make([]RestAPIEndpointConfigurationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RestAPIParameters) DeepCopyInto(out *RestAPIParameters) {
	*out = *in
	...
	if in.EndpointConfiguration != nil {
		in, out := &in.EndpointConfiguration, &out.EndpointConfiguration
		*out = make([]RestAPIEndpointConfigurationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *StageInitParameters) DeepCopyInto(out *StageInitParameters) {
	*out = *in
	...
	if in.CanarySettings != nil {
		...
		*out = make([]CanarySettingsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *StageParameters) DeepCopyInto(out *StageParameters) {
	*out = *in
	...
	if in.CanarySettings != nil {
		in, out := &in.CanarySettings, &out.CanarySettings
		*out = make([]CanarySettingsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *UsagePlanInitParameters) DeepCopyInto(out *UsagePlanInitParameters) {
	*out = *in
	...
	if in.QuotaSettings != nil {
		...
		*out = make([]QuotaSettingsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.ThrottleSettings != nil {
		in, out := &in.ThrottleSettings, &out.ThrottleSettings
		*out = make([]UsagePlanThrottleSettingsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *UsagePlanParameters) DeepCopyInto(out *UsagePlanParameters) {
	*out = *in
	...
	if in.ThrottleSettings != nil {
		in, out := &in.ThrottleSettings, &out.ThrottleSettings
		*out = make([]UsagePlanThrottleSettingsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UsagePlanThrottleSettingsInitParameters) DeepCopyInto(out *UsagePlanThrottleSettingsInitParameters) {
	*out = *in
	if in.BurstLimit != nil {
		in, out := &in.BurstLimit, &out.BurstLimit
		*out = new(float64)
...
func (in *UsagePlanThrottleSettingsInitParameters) DeepCopy() *UsagePlanThrottleSettingsInitParameters {
	if in == nil {
		return nil
	}
	out := new(UsagePlanThrottleSettingsInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *UsagePlanThrottleSettingsObservation) DeepCopy() *UsagePlanThrottleSettingsObservation {
	if in == nil {
		return nil
	}
	out := new(UsagePlanThrottleSettingsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UsagePlanThrottleSettingsParameters) DeepCopyInto(out *UsagePlanThrottleSettingsParameters) {
	*out = *in
	if in.BurstLimit != nil {
		in, out := &in.BurstLimit, &out.BurstLimit
		*out = new(float64)
...
func (in *UsagePlanThrottleSettingsParameters) DeepCopy() *UsagePlanThrottleSettingsParameters {
	if in == nil {
		return nil
	}
	out := new(UsagePlanThrottleSettingsParameters)
	in.DeepCopyInto(out)
	return out
}
