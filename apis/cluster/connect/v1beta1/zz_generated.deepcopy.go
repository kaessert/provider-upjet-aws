...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CrossChannelBehaviorInitParameters) DeepCopyInto(out *CrossChannelBehaviorInitParameters) {
	*out = *in
	if in.BehaviorType != nil {
		in, out := &in.BehaviorType, &out.BehaviorType
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CrossChannelBehaviorInitParameters.
func (in *CrossChannelBehaviorInitParameters) DeepCopy() *CrossChannelBehaviorInitParameters {
	if in == nil {
		return nil
	}
	out := new(CrossChannelBehaviorInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CrossChannelBehaviorObservation) DeepCopyInto(out *CrossChannelBehaviorObservation) {
	*out = *in
	if in.BehaviorType != nil {
		in, out := &in.BehaviorType, &out.BehaviorType
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CrossChannelBehaviorObservation.
func (in *CrossChannelBehaviorObservation) DeepCopy() *CrossChannelBehaviorObservation {
	if in == nil {
		return nil
	}
	out := new(CrossChannelBehaviorObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CrossChannelBehaviorParameters) DeepCopyInto(out *CrossChannelBehaviorParameters) {
	*out = *in
	if in.BehaviorType != nil {
		in, out := &in.BehaviorType, &out.BehaviorType
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CrossChannelBehaviorParameters.
func (in *CrossChannelBehaviorParameters) DeepCopy() *CrossChannelBehaviorParameters {
	if in == nil {
		return nil
	}
	out := new(CrossChannelBehaviorParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MediaConcurrenciesInitParameters) DeepCopyInto(out *MediaConcurrenciesInitParameters) {
	*out = *in
	...
	if in.CrossChannelBehavior != nil {
		in, out := &in.CrossChannelBehavior, &out.CrossChannelBehavior
		*out = make([]CrossChannelBehaviorInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MediaConcurrenciesObservation) DeepCopyInto(out *MediaConcurrenciesObservation) {
	*out = *in
	...
	if in.CrossChannelBehavior != nil {
		in, out := &in.CrossChannelBehavior, &out.CrossChannelBehavior
		*out = make([]CrossChannelBehaviorObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MediaConcurrenciesParameters) DeepCopyInto(out *MediaConcurrenciesParameters) {
	*out = *in
	...
	if in.CrossChannelBehavior != nil {
		in, out := &in.CrossChannelBehavior, &out.CrossChannelBehavior
		*out = make([]CrossChannelBehaviorParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
