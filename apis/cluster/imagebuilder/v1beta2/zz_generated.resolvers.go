...
func (mg *ContainerRecipe) ResolveReferences( // ResolveReferences of this ContainerRecipe.
...
func (mg *Image) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("imagebuilder.aws.upbound.io", "v1beta2", "DistributionConfiguration", "DistributionConfigurationList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("imagebuilder.aws.upbound.io", "v1beta2", "ImageRecipe", "ImageRecipeList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("imagebuilder.aws.upbound.io", "v1beta2", "InfrastructureConfiguration", "InfrastructureConfigurationList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
