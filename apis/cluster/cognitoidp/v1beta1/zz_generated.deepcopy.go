...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AdvancedSecurityAdditionalFlowsInitParameters) DeepCopyInto(out *AdvancedSecurityAdditionalFlowsInitParameters) {
	*out = *in
	if in.CustomAuthMode != nil {
		in, out := &in.CustomAuthMode, &out.CustomAuthMode
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdvancedSecurityAdditionalFlowsInitParameters.
func (in *AdvancedSecurityAdditionalFlowsInitParameters) DeepCopy() *AdvancedSecurityAdditionalFlowsInitParameters {
	if in == nil {
		return nil
	}
	out := new(AdvancedSecurityAdditionalFlowsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AdvancedSecurityAdditionalFlowsObservation) DeepCopyInto(out *AdvancedSecurityAdditionalFlowsObservation) {
	*out = *in
	if in.CustomAuthMode != nil {
		in, out := &in.CustomAuthMode, &out.CustomAuthMode
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdvancedSecurityAdditionalFlowsObservation.
func (in *AdvancedSecurityAdditionalFlowsObservation) DeepCopy() *AdvancedSecurityAdditionalFlowsObservation {
	if in == nil {
		return nil
	}
	out := new(AdvancedSecurityAdditionalFlowsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AdvancedSecurityAdditionalFlowsParameters) DeepCopyInto(out *AdvancedSecurityAdditionalFlowsParameters) {
	*out = *in
	if in.CustomAuthMode != nil {
		in, out := &in.CustomAuthMode, &out.CustomAuthMode
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdvancedSecurityAdditionalFlowsParameters.
func (in *AdvancedSecurityAdditionalFlowsParameters) DeepCopy() *AdvancedSecurityAdditionalFlowsParameters {
	if in == nil {
		return nil
	}
	out := new(AdvancedSecurityAdditionalFlowsParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LambdaConfigInitParameters) DeepCopyInto(out *LambdaConfigInitParameters) {
	*out = *in
	...
	if in.PreTokenGenerationConfig != nil {
		...
		*out = make([]PreTokenGenerationConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *LambdaConfigObservation) DeepCopyInto(out *LambdaConfigObservation) {
	*out = *in
	...
	if in.PreTokenGenerationConfig != nil {
		in, out := &in.PreTokenGenerationConfig, &out.PreTokenGenerationConfig
		*out = make([]PreTokenGenerationConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *LambdaConfigParameters) DeepCopyInto(out *LambdaConfigParameters) {
	*out = *in
	...
	if in.PreTokenGenerationConfig != nil {
		in, out := &in.PreTokenGenerationConfig, &out.PreTokenGenerationConfig
		*out = make([]PreTokenGenerationConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RefreshTokenRotationInitParameters) DeepCopyInto(out *RefreshTokenRotationInitParameters) {
	*out = *in
	if in.Feature != nil {
	...
	if in.RetryGracePeriodSeconds != nil {
		in, out := &in.RetryGracePeriodSeconds, &out.RetryGracePeriodSeconds
		*out = new(float64)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RefreshTokenRotationInitParameters.
func (in *RefreshTokenRotationInitParameters) DeepCopy() *RefreshTokenRotationInitParameters {
	if in == nil {
		return nil
	}
	out := new(RefreshTokenRotationInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RefreshTokenRotationObservation) DeepCopyInto(out *RefreshTokenRotationObservation) {
	*out = *in
	if in.Feature != nil {
		in, out := &in.Feature, &out.Feature
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RefreshTokenRotationObservation.
func (in *RefreshTokenRotationObservation) DeepCopy() *RefreshTokenRotationObservation {
	if in == nil {
		return nil
	}
	out := new(RefreshTokenRotationObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RefreshTokenRotationParameters) DeepCopyInto(out *RefreshTokenRotationParameters) {
	*out = *in
	if in.Feature != nil {
		in, out := &in.Feature, &out.Feature
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RefreshTokenRotationParameters.
func (in *RefreshTokenRotationParameters) DeepCopy() *RefreshTokenRotationParameters {
	if in == nil {
		return nil
	}
	out := new(RefreshTokenRotationParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *UserPoolAddOnsInitParameters) DeepCopyInto(out *UserPoolAddOnsInitParameters) {
	*out = *in
	if in.AdvancedSecurityAdditionalFlows != nil {
		in, out := &in.AdvancedSecurityAdditionalFlows, &out.AdvancedSecurityAdditionalFlows
		*out = make([]AdvancedSecurityAdditionalFlowsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *UserPoolAddOnsObservation) DeepCopyInto(out *UserPoolAddOnsObservation) {
	*out = *in
	if in.AdvancedSecurityAdditionalFlows != nil {
		in, out := &in.AdvancedSecurityAdditionalFlows, &out.AdvancedSecurityAdditionalFlows
		*out = make([]AdvancedSecurityAdditionalFlowsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *UserPoolAddOnsParameters) DeepCopyInto(out *UserPoolAddOnsParameters) {
	*out = *in
	if in.AdvancedSecurityAdditionalFlows != nil {
		in, out := &in.AdvancedSecurityAdditionalFlows, &out.AdvancedSecurityAdditionalFlows
		*out = make([]AdvancedSecurityAdditionalFlowsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *UserPoolClientInitParameters) DeepCopyInto(out *UserPoolClientInitParameters) {
	*out = *in
	...
	if in.RefreshTokenRotation != nil {
		...
		*out = make([]RefreshTokenRotationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *UserPoolClientObservation) DeepCopyInto(out *UserPoolClientObservation) {
	*out = *in
	...
	if in.RefreshTokenRotation != nil {
		in, out := &in.RefreshTokenRotation, &out.RefreshTokenRotation
		*out = make([]RefreshTokenRotationObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *UserPoolClientParameters) DeepCopyInto(out *UserPoolClientParameters) {
	*out = *in
	...
	if in.RefreshTokenRotation != nil {
		in, out := &in.RefreshTokenRotation, &out.RefreshTokenRotation
		*out = make([]RefreshTokenRotationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *UserPoolInitParameters) DeepCopyInto(out *UserPoolInitParameters) {
	*out = *in
	...
	if in.EmailMfaConfiguration != nil {
		...
		*out = make([]EmailMfaConfigurationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.SignInPolicy != nil {
		...
		*out = make([]SignInPolicyInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *UserPoolObservation) DeepCopyInto(out *UserPoolObservation) {
	*out = *in
	...
	if in.EmailMfaConfiguration != nil {
		in, out := &in.EmailMfaConfiguration, &out.EmailMfaConfiguration
		*out = make([]EmailMfaConfigurationObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.SignInPolicy != nil {
		in, out := &in.SignInPolicy, &out.SignInPolicy
		*out = make([]SignInPolicyObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *UserPoolParameters) DeepCopyInto(out *UserPoolParameters) {
	*out = *in
	...
	if in.EmailMfaConfiguration != nil {
		in, out := &in.EmailMfaConfiguration, &out.EmailMfaConfiguration
		*out = make([]EmailMfaConfigurationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.SignInPolicy != nil {
		in, out := &in.SignInPolicy, &out.SignInPolicy
		*out = make([]SignInPolicyParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
