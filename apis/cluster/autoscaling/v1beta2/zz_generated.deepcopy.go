...
func (in *AutoscalingGroupInitParameters) DeepCopyInto(out *AutoscalingGroupInitParameters) {
	*out = *in
	if in.AvailabilityZoneDistribution != nil {
		in, out := &in.AvailabilityZoneDistribution, &out.AvailabilityZoneDistribution
		*out = make([]AvailabilityZoneDistributionInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AutoscalingGroupObservation) DeepCopyInto(out *AutoscalingGroupObservation) {
	*out = *in
	...
	if in.AvailabilityZoneDistribution != nil {
		in, out := &in.AvailabilityZoneDistribution, &out.AvailabilityZoneDistribution
		*out = make([]AvailabilityZoneDistributionObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AutoscalingGroupParameters) DeepCopyInto(out *AutoscalingGroupParameters) {
	*out = *in
	if in.AvailabilityZoneDistribution != nil {
		in, out := &in.AvailabilityZoneDistribution, &out.AvailabilityZoneDistribution
		*out = make([]AvailabilityZoneDistributionParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AvailabilityZoneDistributionInitParameters) DeepCopyInto(out *AvailabilityZoneDistributionInitParameters) {
	*out = *in
	if in.CapacityDistributionStrategy != nil {
		in, out := &in.CapacityDistributionStrategy, &out.CapacityDistributionStrategy
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AvailabilityZoneDistributionInitParameters.
func (in *AvailabilityZoneDistributionInitParameters) DeepCopy() *AvailabilityZoneDistributionInitParameters {
	if in == nil {
		return nil
	}
	out := new(AvailabilityZoneDistributionInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AvailabilityZoneDistributionObservation) DeepCopyInto(out *AvailabilityZoneDistributionObservation) {
	*out = *in
	if in.CapacityDistributionStrategy != nil {
		in, out := &in.CapacityDistributionStrategy, &out.CapacityDistributionStrategy
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AvailabilityZoneDistributionObservation.
func (in *AvailabilityZoneDistributionObservation) DeepCopy() *AvailabilityZoneDistributionObservation {
	if in == nil {
		return nil
	}
	out := new(AvailabilityZoneDistributionObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AvailabilityZoneDistributionParameters) DeepCopyInto(out *AvailabilityZoneDistributionParameters) {
	*out = *in
	if in.CapacityDistributionStrategy != nil {
		in, out := &in.CapacityDistributionStrategy, &out.CapacityDistributionStrategy
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AvailabilityZoneDistributionParameters.
func (in *AvailabilityZoneDistributionParameters) DeepCopy() *AvailabilityZoneDistributionParameters {
	if in == nil {
		return nil
	}
	out := new(AvailabilityZoneDistributionParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CapacityReservationTargetInitParameters) DeepCopyInto(out *CapacityReservationTargetInitParameters) {
	*out = *in
	if in.CapacityReservationIds != nil {
		in, out := &in.CapacityReservationIds, &out.CapacityReservationIds
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.CapacityReservationResourceGroupArns != nil {
		in, out := &in.CapacityReservationResourceGroupArns, &out.CapacityReservationResourceGroupArns
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
func (in *PreferencesInitParameters) DeepCopyInto(out *PreferencesInitParameters) {
	*out = *in
	if in.AlarmSpecification != nil {
		...
		*out = make([]AlarmSpecificationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PreferencesObservation) DeepCopyInto(out *PreferencesObservation) {
	*out = *in
	if in.AlarmSpecification != nil {
		in, out := &in.AlarmSpecification, &out.AlarmSpecification
		*out = make([]AlarmSpecificationObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PreferencesParameters) DeepCopyInto(out *PreferencesParameters) {
	*out = *in
	if in.AlarmSpecification != nil {
		in, out := &in.AlarmSpecification, &out.AlarmSpecification
		*out = make([]AlarmSpecificationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
