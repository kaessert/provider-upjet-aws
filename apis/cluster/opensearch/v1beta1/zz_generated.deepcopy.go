...
func (in *AdvancedSecurityOptionsInitParameters) DeepCopyInto(out *AdvancedSecurityOptionsInitParameters) {
	*out = *in
	...
	if in.JwtOptions != nil {
		in, out := &in.JwtOptions, &out.JwtOptions
		*out = make([]JwtOptionsInitParameters, len(*in))
		for i := range *in {
...
func (in *AdvancedSecurityOptionsObservation) DeepCopyInto(out *AdvancedSecurityOptionsObservation) {
	*out = *in
	...
	if in.JwtOptions != nil {
		in, out := &in.JwtOptions, &out.JwtOptions
		*out = make([]JwtOptionsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AdvancedSecurityOptionsParameters) DeepCopyInto(out *AdvancedSecurityOptionsParameters) {
	*out = *in
	...
	if in.JwtOptions != nil {
		in, out := &in.JwtOptions, &out.JwtOptions
		*out = make([]JwtOptionsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AimlOptionsInitParameters) DeepCopyInto(out *AimlOptionsInitParameters) {
	*out = *in
	if in.NaturalLanguageQueryGenerationOptions != nil {
		in, out := &in.NaturalLanguageQueryGenerationOptions, &out.NaturalLanguageQueryGenerationOptions
		*out = make([]NaturalLanguageQueryGenerationOptionsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.S3VectorsEngine != nil {
		in, out := &in.S3VectorsEngine, &out.S3VectorsEngine
		*out = make([]S3VectorsEngineInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ServerlessVectorAcceleration != nil {
		in, out := &in.ServerlessVectorAcceleration, &out.ServerlessVectorAcceleration
		*out = make([]ServerlessVectorAccelerationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AimlOptionsInitParameters.
func (in *AimlOptionsInitParameters) DeepCopy() *AimlOptionsInitParameters {
	if in == nil {
		return nil
	}
	out := new(AimlOptionsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AimlOptionsObservation) DeepCopyInto(out *AimlOptionsObservation) {
	*out = *in
	if in.NaturalLanguageQueryGenerationOptions != nil {
		in, out := &in.NaturalLanguageQueryGenerationOptions, &out.NaturalLanguageQueryGenerationOptions
		*out = make([]NaturalLanguageQueryGenerationOptionsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.S3VectorsEngine != nil {
		in, out := &in.S3VectorsEngine, &out.S3VectorsEngine
		*out = make([]S3VectorsEngineObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ServerlessVectorAcceleration != nil {
		in, out := &in.ServerlessVectorAcceleration, &out.ServerlessVectorAcceleration
		*out = make([]ServerlessVectorAccelerationObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AimlOptionsObservation.
func (in *AimlOptionsObservation) DeepCopy() *AimlOptionsObservation {
	if in == nil {
		return nil
	}
	out := new(AimlOptionsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AimlOptionsParameters) DeepCopyInto(out *AimlOptionsParameters) {
	*out = *in
	if in.NaturalLanguageQueryGenerationOptions != nil {
		in, out := &in.NaturalLanguageQueryGenerationOptions, &out.NaturalLanguageQueryGenerationOptions
		*out = make([]NaturalLanguageQueryGenerationOptionsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.S3VectorsEngine != nil {
		in, out := &in.S3VectorsEngine, &out.S3VectorsEngine
		*out = make([]S3VectorsEngineParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ServerlessVectorAcceleration != nil {
		in, out := &in.ServerlessVectorAcceleration, &out.ServerlessVectorAcceleration
		*out = make([]ServerlessVectorAccelerationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AimlOptionsParameters.
func (in *AimlOptionsParameters) DeepCopy() *AimlOptionsParameters {
	if in == nil {
		return nil
	}
	out := new(AimlOptionsParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterConfigInitParameters) DeepCopyInto(out *ClusterConfigInitParameters) {
	*out = *in
	...
	if in.NodeOptions != nil {
		in, out := &in.NodeOptions, &out.NodeOptions
		*out = make([]NodeOptionsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ClusterConfigObservation) DeepCopyInto(out *ClusterConfigObservation) {
	*out = *in
	...
	if in.NodeOptions != nil {
		in, out := &in.NodeOptions, &out.NodeOptions
		*out = make([]NodeOptionsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ClusterConfigParameters) DeepCopyInto(out *ClusterConfigParameters) {
	*out = *in
	...
	if in.NodeOptions != nil {
		in, out := &in.NodeOptions, &out.NodeOptions
		*out = make([]NodeOptionsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DomainInitParameters) DeepCopyInto(out *DomainInitParameters) {
	*out = *in
	...
	if in.AimlOptions != nil {
		in, out := &in.AimlOptions, &out.AimlOptions
		*out = make([]AimlOptionsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.IdentityCenterOptions != nil {
		in, out := &in.IdentityCenterOptions, &out.IdentityCenterOptions
		*out = make([]IdentityCenterOptionsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DomainObservation) DeepCopyInto(out *DomainObservation) {
	*out = *in
	...
	if in.AimlOptions != nil {
		in, out := &in.AimlOptions, &out.AimlOptions
		*out = make([]AimlOptionsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.IdentityCenterOptions != nil {
		in, out := &in.IdentityCenterOptions, &out.IdentityCenterOptions
		*out = make([]IdentityCenterOptionsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DomainParameters) DeepCopyInto(out *DomainParameters) {
	*out = *in
	...
	if in.AimlOptions != nil {
		in, out := &in.AimlOptions, &out.AimlOptions
		*out = make([]AimlOptionsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.IdentityCenterOptions != nil {
		in, out := &in.IdentityCenterOptions, &out.IdentityCenterOptions
		*out = make([]IdentityCenterOptionsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IdentityCenterOptionsInitParameters) DeepCopyInto(out *IdentityCenterOptionsInitParameters) {
	*out = *in
	if in.EnabledAPIAccess != nil {
		in, out := &in.EnabledAPIAccess, &out.EnabledAPIAccess
		*out = new(bool)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IdentityCenterOptionsInitParameters.
func (in *IdentityCenterOptionsInitParameters) DeepCopy() *IdentityCenterOptionsInitParameters {
	if in == nil {
		return nil
	}
	out := new(IdentityCenterOptionsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IdentityCenterOptionsObservation) DeepCopyInto(out *IdentityCenterOptionsObservation) {
	*out = *in
	if in.EnabledAPIAccess != nil {
		in, out := &in.EnabledAPIAccess, &out.EnabledAPIAccess
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IdentityCenterOptionsObservation.
func (in *IdentityCenterOptionsObservation) DeepCopy() *IdentityCenterOptionsObservation {
	if in == nil {
		return nil
	}
	out := new(IdentityCenterOptionsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IdentityCenterOptionsParameters) DeepCopyInto(out *IdentityCenterOptionsParameters) {
	*out = *in
	if in.EnabledAPIAccess != nil {
		in, out := &in.EnabledAPIAccess, &out.EnabledAPIAccess
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IdentityCenterOptionsParameters.
func (in *IdentityCenterOptionsParameters) DeepCopy() *IdentityCenterOptionsParameters {
	if in == nil {
		return nil
	}
	out := new(IdentityCenterOptionsParameters)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JwtOptionsInitParameters) DeepCopyInto(out *JwtOptionsInitParameters) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JwtOptionsInitParameters.
func (in *JwtOptionsInitParameters) DeepCopy() *JwtOptionsInitParameters {
	if in == nil {
		return nil
	}
	out := new(JwtOptionsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JwtOptionsObservation) DeepCopyInto(out *JwtOptionsObservation) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JwtOptionsObservation.
func (in *JwtOptionsObservation) DeepCopy() *JwtOptionsObservation {
	if in == nil {
		return nil
	}
	out := new(JwtOptionsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JwtOptionsParameters) DeepCopyInto(out *JwtOptionsParameters) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JwtOptionsParameters.
func (in *JwtOptionsParameters) DeepCopy() *JwtOptionsParameters {
	if in == nil {
		return nil
	}
	out := new(JwtOptionsParameters)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NaturalLanguageQueryGenerationOptionsInitParameters) DeepCopyInto(out *NaturalLanguageQueryGenerationOptionsInitParameters) {
	*out = *in
	if in.DesiredState != nil {
		in, out := &in.DesiredState, &out.DesiredState
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NaturalLanguageQueryGenerationOptionsInitParameters.
func (in *NaturalLanguageQueryGenerationOptionsInitParameters) DeepCopy() *NaturalLanguageQueryGenerationOptionsInitParameters {
	if in == nil {
		return nil
	}
	out := new(NaturalLanguageQueryGenerationOptionsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NaturalLanguageQueryGenerationOptionsObservation) DeepCopyInto(out *NaturalLanguageQueryGenerationOptionsObservation) {
	*out = *in
	if in.DesiredState != nil {
		in, out := &in.DesiredState, &out.DesiredState
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NaturalLanguageQueryGenerationOptionsObservation.
func (in *NaturalLanguageQueryGenerationOptionsObservation) DeepCopy() *NaturalLanguageQueryGenerationOptionsObservation {
	if in == nil {
		return nil
	}
	out := new(NaturalLanguageQueryGenerationOptionsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NaturalLanguageQueryGenerationOptionsParameters) DeepCopyInto(out *NaturalLanguageQueryGenerationOptionsParameters) {
	*out = *in
	if in.DesiredState != nil {
		in, out := &in.DesiredState, &out.DesiredState
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NaturalLanguageQueryGenerationOptionsParameters.
func (in *NaturalLanguageQueryGenerationOptionsParameters) DeepCopy() *NaturalLanguageQueryGenerationOptionsParameters {
	if in == nil {
		return nil
	}
	out := new(NaturalLanguageQueryGenerationOptionsParameters)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeOptionsInitParameters) DeepCopyInto(out *NodeOptionsInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeOptionsInitParameters.
func (in *NodeOptionsInitParameters) DeepCopy() *NodeOptionsInitParameters {
	if in == nil {
		return nil
	}
	out := new(NodeOptionsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeOptionsObservation) DeepCopyInto(out *NodeOptionsObservation) {
	*out = *in
	if in.NodeConfig != nil {
		in, out := &in.NodeConfig, &out.NodeConfig
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeOptionsObservation.
func (in *NodeOptionsObservation) DeepCopy() *NodeOptionsObservation {
	if in == nil {
		return nil
	}
	out := new(NodeOptionsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeOptionsParameters) DeepCopyInto(out *NodeOptionsParameters) {
	*out = *in
	if in.NodeConfig != nil {
		in, out := &in.NodeConfig, &out.NodeConfig
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeOptionsParameters.
func (in *NodeOptionsParameters) DeepCopy() *NodeOptionsParameters {
	if in == nil {
		return nil
	}
	out := new(NodeOptionsParameters)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *S3VectorsEngineInitParameters) DeepCopyInto(out *S3VectorsEngineInitParameters) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new S3VectorsEngineInitParameters.
func (in *S3VectorsEngineInitParameters) DeepCopy() *S3VectorsEngineInitParameters {
	if in == nil {
		return nil
	}
	out := new(S3VectorsEngineInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *S3VectorsEngineObservation) DeepCopyInto(out *S3VectorsEngineObservation) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new S3VectorsEngineObservation.
func (in *S3VectorsEngineObservation) DeepCopy() *S3VectorsEngineObservation {
	if in == nil {
		return nil
	}
	out := new(S3VectorsEngineObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *S3VectorsEngineParameters) DeepCopyInto(out *S3VectorsEngineParameters) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new S3VectorsEngineParameters.
func (in *S3VectorsEngineParameters) DeepCopy() *S3VectorsEngineParameters {
	if in == nil {
		return nil
	}
	out := new(S3VectorsEngineParameters)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerlessVectorAccelerationInitParameters) DeepCopyInto(out *ServerlessVectorAccelerationInitParameters) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServerlessVectorAccelerationInitParameters.
func (in *ServerlessVectorAccelerationInitParameters) DeepCopy() *ServerlessVectorAccelerationInitParameters {
	if in == nil {
		return nil
	}
	out := new(ServerlessVectorAccelerationInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerlessVectorAccelerationObservation) DeepCopyInto(out *ServerlessVectorAccelerationObservation) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServerlessVectorAccelerationObservation.
func (in *ServerlessVectorAccelerationObservation) DeepCopy() *ServerlessVectorAccelerationObservation {
	if in == nil {
		return nil
	}
	out := new(ServerlessVectorAccelerationObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerlessVectorAccelerationParameters) DeepCopyInto(out *ServerlessVectorAccelerationParameters) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServerlessVectorAccelerationParameters.
func (in *ServerlessVectorAccelerationParameters) DeepCopy() *ServerlessVectorAccelerationParameters {
	if in == nil {
		return nil
	}
	out := new(ServerlessVectorAccelerationParameters)
	in.DeepCopyInto(out)
	return out
}
