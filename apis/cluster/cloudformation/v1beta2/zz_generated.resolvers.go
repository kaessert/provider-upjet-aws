...
func (mg *StackSet) ResolveReferences( // ResolveReferences of this StackSet.
...
func (mg *StackSetInstance) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("cloudformation.aws.upbound.io", "v1beta2", "StackSet", "StackSetList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
