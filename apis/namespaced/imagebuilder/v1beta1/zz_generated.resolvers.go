...
func (mg *ContainerRecipe) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.Component); i3++ {
		{
			m, l, err = apisresolver.GetManagedResource("imagebuilder.aws.m.upbound.io", "v1beta1", "Component", "ComponentList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
	...
	if mg.Spec.ForProvider.TargetRepository != nil {
		{
		...
		if err != nil {
			return errors.Wrap(err, "mg.Spec.ForProvider.TargetRepository.RepositoryName")
		}
		mg.Spec.ForProvider.TargetRepository.RepositoryName = reference.ToPtrValue(rsp.ResolvedValue)
		mg.Spec.ForProvider.TargetRepository.RepositoryNameRef = rsp.ResolvedReference
	...
	if mg.Spec.InitProvider.TargetRepository != nil {
		{
			m, l, err = apisresolver.GetManagedResource("ecr.aws.m.upbound.io", "v1beta1", "Repository", "RepositoryList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		...
		if err != nil {
			return errors.Wrap(err, "mg.Spec.InitProvider.TargetRepository.RepositoryName")
		}
		mg.Spec.InitProvider.TargetRepository.RepositoryName = reference.ToPtrValue(rsp.ResolvedValue)
		mg.Spec.InitProvider.TargetRepository.RepositoryNameRef = rsp.ResolvedReference
...
func (mg *Image) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("imagebuilder.aws.m.upbound.io", "v1beta1", "DistributionConfiguration", "DistributionConfigurationList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("imagebuilder.aws.m.upbound.io", "v1beta1", "ImageRecipe", "ImageRecipeList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("imagebuilder.aws.m.upbound.io", "v1beta1", "InfrastructureConfiguration", "InfrastructureConfigurationList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *InfrastructureConfiguration) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("ec2.aws.m.upbound.io", "v1beta1", "KeyPair", "KeyPairList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	if mg.Spec.ForProvider.Logging != nil {
		if mg.Spec.ForProvider.Logging.S3Logs != nil {
			{
			...
			if err != nil {
				return errors.Wrap(err, "mg.Spec.ForProvider.Logging.S3Logs.S3BucketName")
			}
			mg.Spec.ForProvider.Logging.S3Logs.S3BucketName = reference.ToPtrValue(rsp.ResolvedValue)
			mg.Spec.ForProvider.Logging.S3Logs.S3BucketNameRef = rsp.ResolvedReference
	...
	if mg.Spec.InitProvider.Logging != nil {
		if mg.Spec.InitProvider.Logging.S3Logs != nil {
			{
				m, l, err = apisresolver.GetManagedResource("s3.aws.m.upbound.io", "v1beta1", "Bucket", "BucketList")
				if err != nil {
					return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			...
			if err != nil {
				return errors.Wrap(err, "mg.Spec.InitProvider.Logging.S3Logs.S3BucketName")
			}
			mg.Spec.InitProvider.Logging.S3Logs.S3BucketName = reference.ToPtrValue(rsp.ResolvedValue)
			mg.Spec.InitProvider.Logging.S3Logs.S3BucketNameRef = rsp.ResolvedReference
