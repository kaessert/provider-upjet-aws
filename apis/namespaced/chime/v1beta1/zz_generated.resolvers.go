...
func (mg *VoiceConnectorGroup) ResolveReferences( // ResolveReferences of this VoiceConnectorGroup.
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.Connector); i3++ {
		{
			m, l, err = apisresolver.GetManagedResource("chime.aws.m.upbound.io", "v1beta1", "VoiceConnector", "VoiceConnectorList")
			if err != nil {
