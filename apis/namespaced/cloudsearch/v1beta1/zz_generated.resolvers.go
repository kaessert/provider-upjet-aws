...
func (mg *DomainServiceAccessPolicy) ResolveReferences( // ResolveReferences of this DomainServiceAccessPolicy.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("cloudsearch.aws.m.upbound.io", "v1beta1", "Domain", "DomainList")
		if err != nil {
