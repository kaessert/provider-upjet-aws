...
// RGLogDeliveryConfigurationRAWParameters defines log delivery configuration for namespaced ReplicationGroup (v1beta1).
...
// RGLogDeliveryConfigurationRAWInitParameters defines init parameters for RG log delivery (namespaced v1beta1).
...
// RGLogDeliveryConfigurationRAWObservation defines observed RG log delivery state (namespaced v1beta1).
...
// NodeGroupConfigurationRAWParameters defines node group configuration (namespaced v1beta1).
...
// NodeGroupConfigurationRAWInitParameters defines init parameters for node group configuration (namespaced v1beta1).
...
// NodeGroupConfigurationRAWObservation defines observed node group configuration (namespaced v1beta1).
...
type ReplicationGroupRAWParameters struct {
	...
	// ARN of the KMS key to use if encrypting at rest.
...
// ReplicationGroupRAWInitParameters defines the namespaced v1beta1 spoke init parameters.
...
// ReplicationGroupRAWObservation defines the observed state of namespaced ReplicationGroupRAW (v1beta1 spoke).
...
// ReplicationGroupRAWSpec defines the desired state of namespaced ReplicationGroupRAW v1beta1 spoke.
...
// ReplicationGroupRAWStatus defines the observed state of namespaced ReplicationGroupRAW v1beta1 spoke.
...
// ReplicationGroupRAW is the namespaced v1beta1 spoke for the native ElastiCache Replication Group resource.
// The hub version is ReplicationGroupRAW in namespaced v1beta2. Use v1beta2 for new resources.
//
...
// ReplicationGroupRAWList contains a list of ReplicationGroupRAW resources (namespaced v1beta1 spoke).
...
// Repository type metadata for namespaced ReplicationGroupRAW v1beta1.
var (
...
// ConvertTo converts namespaced ReplicationGroupRAW v1beta1 to the namespaced hub v1beta2.
func (src *ReplicationGroupRAW) ConvertTo(dstRaw conversion.Hub) error {
	dst, ok := dstRaw.(*namespacedv2native.ReplicationGroupRAW)
	if !ok {
		return fmt.Errorf("expected *namespacedv2native.ReplicationGroupRAW, got %T", dstRaw)
	}
...
// ConvertFrom converts from the namespaced hub ReplicationGroupRAW v1beta2 to namespaced v1beta1.
func (dst *ReplicationGroupRAW) ConvertFrom(srcRaw conversion.Hub) error {
	src, ok := srcRaw.(*namespacedv2native.ReplicationGroupRAW)
	if !ok {
		return fmt.Errorf("expected *namespacedv2native.ReplicationGroupRAW, got %T", srcRaw)
	}
	data, err := json.Marshal(src)
	if err != nil {
		return err
...
func (r *ReplicationGroupRAW) SetForProvider(p ReplicationGroupRAWParameters) { r.Spec.ForProvider = p }
