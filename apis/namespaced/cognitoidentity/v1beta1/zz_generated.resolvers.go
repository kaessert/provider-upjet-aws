...
func (mg *CognitoIdentityPoolProviderPrincipalTag) ResolveReferences( // ResolveReferences of this CognitoIdentityPoolProviderPrincipalTag.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("cognitoidentity.aws.m.upbound.io", "v1beta1", "Pool", "PoolList")
		if err != nil {
...
func (mg *Pool) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("iam.aws.m.upbound.io", "v1beta1", "SAMLProvider", "SAMLProviderList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
