...
func (mg *EnvironmentEC2) ResolveReferences( // ResolveReferences of this EnvironmentEC2.
...
func (mg *EnvironmentMembership) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("cloud9.aws.m.upbound.io", "v1beta1", "EnvironmentEC2", "EnvironmentEC2List")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
