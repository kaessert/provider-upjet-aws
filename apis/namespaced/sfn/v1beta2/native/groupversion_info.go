...
// +groupName=sfn.aws.m.upbound.io
// +versionName=v1beta2
...
const (
	// CRDGroup is the API Group for all native sfn types in this package.
	CRDGroup = "sfn.aws.m.upbound.io"

	// CRDVersion is the API Version for all native sfn types in this package.
	CRDVersion = "v1beta2"
)
