...
func (in *ResourceConfigurationObservation) DeepCopyInto(out *ResourceConfigurationObservation) {
	*out = *in
	...
	if in.DomainVerificationArn != nil {
		in, out := &in.DomainVerificationArn, &out.DomainVerificationArn
		*out = new(string)
		**out = **in
	}
	if in.DomainVerificationID != nil {
...
func (in *ResourceGatewayInitParameters) DeepCopyInto(out *ResourceGatewayInitParameters) {
	*out = *in
	...
	if in.IPv4AddressesPerEni != nil {
		in, out := &in.IPv4AddressesPerEni, &out.IPv4AddressesPerEni
		*out = new(float64)
		**out = **in
	}
	if in.Name != nil {
