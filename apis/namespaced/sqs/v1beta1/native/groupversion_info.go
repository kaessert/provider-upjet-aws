...
// +groupName=sqs.aws.m.upbound.io
// +versionName=v1beta1
...
const (
	// CRDGroup is the API Group for all native sqs types in this package.
	CRDGroup = "sqs.aws.m.upbound.io"

	// CRDVersion is the API Version for all native sqs types in this package.
	CRDVersion = "v1beta1"
)
