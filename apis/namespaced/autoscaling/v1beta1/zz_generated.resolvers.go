...
func (mg *Attachment) ResolveReferences( // ResolveReferences of this Attachment.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("autoscaling.aws.m.upbound.io", "v1beta1", "AutoscalingGroup", "AutoscalingGroupList")
		if err != nil {
...
func (mg *AutoscalingGroup) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("autoscaling.aws.m.upbound.io", "v1beta1", "LaunchConfiguration", "LaunchConfigurationList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("ec2.aws.m.upbound.io", "v1beta1", "PlacementGroup", "PlacementGroupList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
