...
func (in *MetricFilterInitParameters) DeepCopyInto(out *MetricFilterInitParameters) {
	*out = *in
	if in.ApplyOnTransformedLogs != nil {
		in, out := &in.ApplyOnTransformedLogs, &out.ApplyOnTransformedLogs
		*out = new(bool)
		**out = **in
	}
...
func (in *SubscriptionFilterInitParameters) DeepCopyInto(out *SubscriptionFilterInitParameters) {
	*out = *in
	...
	if in.EmitSystemFields != nil {
		in, out := &in.EmitSystemFields, &out.EmitSystemFields
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
